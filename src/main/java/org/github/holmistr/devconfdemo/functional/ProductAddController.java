...
/**
 * Controller for adding entries to cache using Functional Map API.
 *
 * @author Jiri Holusa (jholusa@redhat.com)
 */
@Named("functionalAddController")
@RequestScoped
public class ProductAddController {
    ...
    public void add() throws ExecutionException, InterruptedException {
        ...
        WriteOnlyMap<Long, Product> writeOnlyMap = WriteOnlyMapImpl.create(functionalMap);

        Product product = new Product(id, name, description, pieces, price);
        CompletableFuture<Void> future = writeOnlyMap.eval(id, v -> v.set(product));
